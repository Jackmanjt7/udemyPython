...
if __name__ == '__main__':
    ...
    ap.add_argument('width',help='width of screen for resolution', type=int)
    ap.add_argument('height',help='height of screen for resolution', type=int)
    args = vars(ap.parse_args())
    width = args['width']
    height = args['height']
    app = Controller(root, width, height)
    root.mainloop()
